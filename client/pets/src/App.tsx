...
function App() {
    return (
        <>
            <NavbarComponent
                brand={{href: "#home", label: "Whisker", logo: "/logo.png"}}
                links={[
                ...
                dropdown={[
                    {
                        ...
                        items: [
                            ...
                            {href: "#cats/accessories", label: "Cat Accessories"},
                            {href: "#cats/care", label: "Cat Care"},
                        ],
                    },
                    {
                        title: "DOGS",
                        items: [
                            {href: "#dogs/food", label: "Dog Food"},
                            {href: "#dogs/accessories", label: "Dog Accessories"},
                            {href: "#dogs/care", label: "Dog Care"},
                        ],
                    }
                ]}
            />
